...
export default function LoginScreen({ navigation, route }) {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      if (err.message && err.message.includes("doğrulayın")) {
          ...
          <ScrollView contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled">
            <Pressable onPress={Keyboard.dismiss} style={{ flex: 1, width: "100%", justifyContent: "center" }}>
              ...
              <View style={styles.header}>
                ...
                <Text style={styles.subtitle}>GingivaX hesabınıza giriş yapın</Text>
              </View>
                ...
                <View style={styles.footerLinks}>
                  ...
                  >
                    <Text style={styles.linkText}>
                      Hesabınız yok mu? <Text style={styles.linkAccent}>Kayıt Olun</Text>
                    </Text>
                  </TouchableOpacity>
                </View>
              </View>
